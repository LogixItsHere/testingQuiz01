...
WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_firstName'), '123')
...
WebUI.click(findTestObject('Object Repository/Page_Swag Labs/div_Close Menu_header_label'))
